...
<html lang="pt-br">
    ...
    <head>
        ...
        <meta name="author" content="Alysson Dornelles">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu1 ?>">Marketing</a>
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu2 ?>">E-commerce</a>
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu3 ?>">Financeiro</a>
                        </div>
                    </div>
                </li>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                        ...
                        <img class="mt-2" src="../img/logo.png" width="125">
